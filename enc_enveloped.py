...
OUTPUT_PATH = "messages/msg_enveloped.txt"
...
# --- Encode SignedData as plaintext for encryption ---
signed_der = encoder.encode(signed_data)
times.append(("SignedData DER encoding klaar", terminal.getTimeStamp()))
